...
.tags-view-container {
  height: var(--HP-tagsview-height);
  width: 100%;
  color: var(--HP-tagsview-text-color);
  overflow: hidden;
  .tags-view-wrapper {
    .tags-view-item {
      ...
      &.active {
        ...
        color: var(--HP-tagsview-tag-active-text-color);
        border-color: var(--HP-tagsview-tag-active-border-color);
      }
      .el-icon {
        margin: 0 2px;
        ...
        border-radius: 50%;
        &:hover {
          background-color: var(--HP-tagsview-tag-icon-hover-bg-color);
          color: var(--HP-tagsview-tag-icon-hover-color);
        }
      }
    }
  }
  .contextmenu {
    ...
    li {
      ...
      &:hover {
        ...
        background-color: var(--HP-tagsview-contextmenu-hover-bg-color);
      }
    }
  }
}
