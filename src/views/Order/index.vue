<template>
  <div class="content-page">
      ...
      <div class="filter-box">
        <el-form :inline="true" :model="filterForm" class="demo-form-inline">
          <el-form-item label="订单号">
            <el-input class="filter-input" v-model="filterForm.order_sn" placeholder="请输入订单号" />
          </el-form-item>
          <el-form-item label="收货人">
            <el-input class="filter-input" v-model="filterForm.consignee" placeholder="请输入收货人" />
          </el-form-item>
          <el-form-item label="快递号">
            <el-input class="filter-input" v-model="filterForm.logistic_code" placeholder="请输入快递单号" />
          </el-form-item>
          <el-form-item>
    ...
    <el-dialog title="提示" v-model:visible="dialogVisible2">
      <span>确定收货？</span>
      <template v-slot:footer>
        <span class="dialog-footer">
    ...
    <el-dialog title="打印快递单" v-model:visible="dialogFormVisible">
      <el-form :model="dform">
        <div class="dialog-wrap">
          ...
          <div class="dialog-main" v-if="dform.method == 1">
            <div class="l">
              ...
              <div class="detail">
                <div class="m1">
                  <div class="user-name">
                    <el-input size="mini" class="senderInput" v-model="sender.name" placeholder="寄件人姓名" />
                  </div>
                  <div class="user-mobile">
                    <el-input size="mini" class="senderInput" v-model="sender.mobile" placeholder="寄件人手机" />
                  </div>
                </div>
          ...
          <div class="dialog-main" v-if="dform.method == 1">
            <div class="l">
              ...
              <div class="detail">
                <div class="m1">
                  <div class="user-name">
                    <el-input size="mini" class="senderInput" v-model="receiver.name" placeholder="收件人姓名" />
                  </div>
                  <div class="user-mobile">
                    <el-input size="mini" class="senderInput" v-model="receiver.mobile" placeholder="收件人手机" />
                  </div>
                </div>
                <div class="user-address">
                  <el-cascader
          ...
          <div v-if="orderInfo.admin_memo != '' && orderInfo.admin_memo != null" class="user-admin-t">
        ...
        <el-form-item label="保价金额及提醒" v-if="expressType == 1">
          <el-input-number
            ...
            placeholder="请输入保价金额"
          />
          <el-input v-model="orderInfo.remark" @blur="changeRemarkInfo(orderInfo)" placeholder="快递单上的提醒" />
        </el-form-item>
        ...
        <el-form-item label="快递单号" v-if="dform.method == 2">
          <el-input v-model="dform.logistic_code" />
        </el-form-item>
      ...
      <template v-slot:footer>
        <div class="dialog-footer print-footer">
          <div class="f-left">
            <el-checkbox v-if="dform.method == 1 && orderInfo.order_status == 300" v-model="autoGoDelivery"
              >打印完成后自动发货
            </el-checkbox>
          </div>
    ...
    <el-dialog title="快递单预览" class="express-dialog" v-model:visible="printMiandan">
      <div
        id="sfbj-block"
      ...
      >
        <div style="display: flex; width: 100%; justify-content: space-between; border-bottom: 1px solid #333">
          <div style="border-right: 1px solid #333; width: 300px; text-align: center">
            <barcode :value="sfHasValue.LogisticCode" height="40" display-value="false" tag="img" />
        ...
        <div style="display: flex; width: 100%; border-bottom: 1px solid #333">
          <div style="width: 100%; text-align: center">
            <barcode :value="sfHasValue.LogisticCode" height="30" display-value="false" tag="img" />
            <div style="width: 100%; margin: 0 auto; text-align: center; font-size: 12px; padding-bottom: 2px">
              快递单号:{{ sfHasValue.LogisticCode }}
            </div>
          </div>
      ...
      >
        ...
        <div style="display: flex; justify-content: flex-start; border-bottom: 1px solid #333; position: relative">
          ...
          <div style="display: flex; element-plustion: column">
            <div style="display: flex; justify-content: flex-start; font-size: 10px">
              {{ receiverInfo.Name }} {{ receiverInfo.Tel }}
            </div>
            <div style="font-size: 10px">
      ...
      >
        <div style="display: flex; width: 100%; border-bottom: 1px solid #333">
          <div style="width: 100%; text-align: center">
            <barcode :value="sfHasValue.LogisticCode" height="50" display-value="false" tag="img" />
            <div style="width: 100%; margin: 0 auto; text-align: center; font-size: 12px; padding-bottom: 2px">
              快递单号:{{ sfHasValue.LogisticCode }}
            </div>
          </div>
        ...
        <div style="width: 100%; text-align: center; height: 60px; font-size: 10px" />
        <div style="display: flex; width: 100%; border-bottom: 1px solid #333">
          <div style="width: 100%; text-align: center">
            <barcode :value="sfHasValue.LogisticCode" height="30" display-value="false" tag="img" />
            <div style="width: 100%; margin: 0 auto; text-align: center; font-size: 12px; padding-bottom: 2px">
    ...
    <el-dialog title="修改价格" v-model:visible="dialogPriceVisible">
...
import {
  getAllRegionDataApi,
  getOrderPriceDataApi,
  getGoPrintOnlyDataApi,
  getGoDeliveryDataApi,
  getMianExpressDataApi,
  getOrderReceiveDataApi,
  checkExpressDataApi,
  directPrintExpressDataApi,
  rePrintExpressDataApi,
  destoryDataApi,
  saveAdminMemoDataApi,
  savePrintInfoDataApi,
  saveRemarkInfoDataApi,
  getOrderpackDataApi,
  getDeliveryDataApi,
  getOrderDeliveryDataApi,
  getAutoStatusDataApi,
...
export default {
  ...
  methods: {
    ...
    getAllRegion() {
      const that = this
      getAllRegionDataApi().then((response) => {
    ...
    getDeliveyInfo() {
      getDeliveryDataApi().then((response) => {
    ...
    changeInfo(info) {
      const id = info.id
      const print_info = info.print_info
      // this.axios
    ...
    deliveyGoConfirm() {
      ...
      getMianExpressDataApi({
        ...
        const expressInfo = response.data.latestExpressInfo
    ...
    printit1() {
      const mywindow = window.open("", "PRINT", "height=1500,width=1000")
    ...
    printit3() {
      const mywindow = window.open("", "PRINT", "height=1800,width=1000")
      mywindow.document.write("<html><head><title></title>")
      mywindow.document.write("</head><body >")
    ...
    getAutoStatus() {
      getAutoStatusDataApi().then((response) => {
